...
import { i as Program$1, n as Expression$1, r as Node$3, t as BaseNode } from "../@types/estree.mjs";
import { t as SectionedSourceMapInput } from "../@jridgewell/trace-mapping.mjs";
import { a as Node$4, c as Statement$1, i as Identifier$1, l as SwitchCase, n as BlockStatement$1, o as ObjectProperty, r as Function$1, s as Program$2, t as PluginConfig } from "../@babel/parser.mjs";
 ...
 */
declare function transform$1<T extends TransformOptions$2>(input: string | Uint8Array, options?: SameShape<TransformOptions$2, T>): Promise<TransformResult$1<T>>;
/**
...
interface DirectiveTransformResult {
  ...
  ssrTagParts?: TemplateLiteral$1['elements'];
}
...
declare function resolveComponentType(node: ComponentNode, context: TransformContext, ssr?: boolean): string | symbol | CallExpression$1;
type PropsExpression = ObjectExpression | CallExpression$1 | ExpressionNode;
...
interface RootNode extends Node$1 {
  type: NodeTypes.ROOT;
  source: string;
...
interface BaseElementNode extends Node$1 {
...
interface TextNode extends Node$1 {
  type: NodeTypes.TEXT;
  content: string;
}
interface CommentNode extends Node$1 {
  type: NodeTypes.COMMENT;
  content: string;
}
interface AttributeNode extends Node$1 {
  type: NodeTypes.ATTRIBUTE;
  name: string;
  nameLoc: SourceLocation;
  value: TextNode | undefined;
}
interface DirectiveNode extends Node$1 {
...
interface SimpleExpressionNode extends Node$1 {
...
interface InterpolationNode extends Node$1 {
  type: NodeTypes.INTERPOLATION;
  content: ExpressionNode;
}
interface CompoundExpressionNode extends Node$1 {
...
interface IfNode extends Node$1 {
  type: NodeTypes.IF;
  branches: IfBranchNode[];
  codegenNode?: IfConditionalExpression | CacheExpression;
}
interface IfBranchNode extends Node$1 {
...
interface ForNode extends Node$1 {
  type: NodeTypes.FOR;
...
interface TextCallNode extends Node$1 {
  type: NodeTypes.TEXT_CALL;
  content: TextNode | InterpolationNode | CompoundExpressionNode;
  codegenNode: CallExpression$1 | SimpleExpressionNode;
}
type TemplateTextChildNode = TextNode | InterpolationNode | CompoundExpressionNode;
interface VNodeCall extends Node$1 {
  type: NodeTypes.VNODE_CALL;
  tag: string | symbol | CallExpression$1;
  props: PropsExpression | undefined;
...
type JSChildNode = VNodeCall | CallExpression$1 | ObjectExpression | ArrayExpression | ExpressionNode | FunctionExpression$1 | ConditionalExpression$1 | CacheExpression | AssignmentExpression$1 | SequenceExpression;
interface CallExpression$1 extends Node$1 {
  type: NodeTypes.JS_CALL_EXPRESSION;
  callee: string | symbol;
  arguments: (string | symbol | JSChildNode | SSRCodegenNode | TemplateChildNode | TemplateChildNode[])[];
}
interface ObjectExpression extends Node$1 {
  type: NodeTypes.JS_OBJECT_EXPRESSION;
  properties: Array<Property>;
}
interface Property extends Node$1 {
  type: NodeTypes.JS_PROPERTY;
  key: ExpressionNode;
  value: JSChildNode;
}
interface ArrayExpression extends Node$1 {
  type: NodeTypes.JS_ARRAY_EXPRESSION;
  elements: Array<string | Node$1>;
}
interface FunctionExpression$1 extends Node$1 {
  type: NodeTypes.JS_FUNCTION_EXPRESSION;
  params: ExpressionNode | string | (ExpressionNode | string)[] | undefined;
  returns?: TemplateChildNode | TemplateChildNode[] | JSChildNode;
  body?: BlockStatement | IfStatement$1;
  newline: boolean;
  /**
...
interface ConditionalExpression$1 extends Node$1 {
...
interface CacheExpression extends Node$1 {
...
interface MemoExpression extends CallExpression$1 {
  callee: typeof WITH_MEMO;
  arguments: [ExpressionNode, MemoFactory, string, string];
}
interface MemoFactory extends FunctionExpression$1 {
  returns: BlockCodegenNode;
}
type SSRCodegenNode = BlockStatement | TemplateLiteral$1 | IfStatement$1 | AssignmentExpression$1 | ReturnStatement$1 | SequenceExpression;
interface BlockStatement extends Node$1 {
  type: NodeTypes.JS_BLOCK_STATEMENT;
  body: (JSChildNode | IfStatement$1)[];
}
interface TemplateLiteral$1 extends Node$1 {
  type: NodeTypes.JS_TEMPLATE_LITERAL;
  elements: (string | JSChildNode)[];
}
interface IfStatement$1 extends Node$1 {
  type: NodeTypes.JS_IF_STATEMENT;
  test: ExpressionNode;
  consequent: BlockStatement;
  alternate: IfStatement$1 | BlockStatement | ReturnStatement$1 | undefined;
}
interface AssignmentExpression$1 extends Node$1 {
  type: NodeTypes.JS_ASSIGNMENT_EXPRESSION;
  left: SimpleExpressionNode;
  right: JSChildNode;
}
interface SequenceExpression extends Node$1 {
  type: NodeTypes.JS_SEQUENCE_EXPRESSION;
  expressions: JSChildNode[];
}
interface ReturnStatement$1 extends Node$1 {
...
interface RenderSlotCall extends CallExpression$1 {
...
interface SlotFunctionExpression extends FunctionExpression$1 {
  returns: TemplateChildNode[] | CacheExpression;
}
interface DynamicSlotsExpression extends CallExpression$1 {
...
interface ConditionalDynamicSlotNode extends ConditionalExpression$1 {
  consequent: DynamicSlotNode;
  alternate: DynamicSlotNode | SimpleExpressionNode;
}
interface ListDynamicSlotNode extends CallExpression$1 {
  callee: typeof RENDER_LIST;
  arguments: [ExpressionNode, ListDynamicSlotIterator];
}
interface ListDynamicSlotIterator extends FunctionExpression$1 {
...
interface IfConditionalExpression extends ConditionalExpression$1 {
...
interface ForRenderListExpression extends CallExpression$1 {
  callee: typeof RENDER_LIST;
  arguments: [ExpressionNode, ForIteratorExpression];
}
interface ForIteratorExpression extends FunctionExpression$1 {
  returns?: BlockCodegenNode;
}
...
type InferCodegenNodeType<T> = T extends typeof RENDER_SLOT ? RenderSlotCall : CallExpression$1;
declare function createCallExpression<T extends CallExpression$1['callee']>(callee: T, args?: CallExpression$1['arguments'], loc?: SourceLocation): InferCodegenNodeType<T>;
declare function createFunctionExpression(params: FunctionExpression$1['params'], returns?: FunctionExpression$1['returns'], newline?: boolean, isSlot?: boolean, loc?: SourceLocation): FunctionExpression$1;
declare function createConditionalExpression(test: ConditionalExpression$1['test'], consequent: ConditionalExpression$1['consequent'], alternate: ConditionalExpression$1['alternate'], newline?: boolean): ConditionalExpression$1;
...
declare function createTemplateLiteral(elements: TemplateLiteral$1['elements']): TemplateLiteral$1;
declare function createIfStatement(test: IfStatement$1['test'], consequent: IfStatement$1['consequent'], alternate?: IfStatement$1['alternate']): IfStatement$1;
declare function createAssignmentExpression(left: AssignmentExpression$1['left'], right: AssignmentExpression$1['right']): AssignmentExpression$1;
declare function createSequenceExpression(expressions: SequenceExpression['expressions']): SequenceExpression;
declare function createReturnStatement(returns: ReturnStatement$1['returns']): ReturnStatement$1;
...
type CompilerOptions$1 = ParserOptions & TransformOptions & CodegenOptions;
/**
...
declare function baseCompile(source: string | RootNode, options?: CompilerOptions$1): CodegenResult;
 ...
 */
declare function walkIdentifiers(root: Node$4, onIdentifier: (node: Identifier$1, parent: Node$4 | null, parentStack: Node$4[], isReference: boolean, isLocal: boolean) => void, includeAll?: boolean, parentStack?: Node$4[], knownIds?: Record<string, number>): void;
declare function isReferencedIdentifier(id: Identifier$1, parent: Node$4 | null, parentStack: Node$4[]): boolean;
declare function isInDestructureAssignment(parent: Node$4, parentStack: Node$4[]): boolean;
declare function isInNewExpression(parentStack: Node$4[]): boolean;
declare function walkFunctionParams(node: Function$1, onIdent: (id: Identifier$1) => void): void;
declare function walkBlockDeclarations(block: BlockStatement$1 | SwitchCase | Program$2, onIdent: (node: Identifier$1) => void): void;
declare function extractIdentifiers(param: Node$4, nodes?: Identifier$1[]): Identifier$1[];
declare const isFunctionType: (node: Node$4) => node is Function$1;
declare const isStaticProperty: (node: Node$4) => node is ObjectProperty;
declare const isStaticPropertyKey: (node: Node$4, parent: Node$4) => boolean;
declare const TS_NODE_TYPES: string[];
declare function unwrapTSNode(node: Node$4): Node$4;
...
type SlotFnBuilder = (slotProps: ExpressionNode | undefined, vFor: DirectiveNode | undefined, slotChildren: TemplateChildNode[], loc: SourceLocation) => FunctionExpression$1;
...
//#region src/index.d.ts
//#endregion
export { FRAGMENT as $, createSequenceExpression as $n, stringifyExpression as $r, SimpleExpressionNode as $t, CodegenSourceMapGenerator as A, baseCompile as An, isMemberExpression as Ar, ObjectExpression as At, CoreCompilerError as B, createCacheExpression as Bn, isTemplateNode as Br, RENDER_SLOT as Bt, CREATE_TEXT as C, VNodeCall as Cn, isCoreComponent as Cr, NORMALIZE_STYLE as Ct, CodegenContext as D, advancePositionWithClone as Dn, isFunctionType as Dr, NodeTransform as Dt, CallExpression$1 as E, WITH_MEMO as En, isFnExpressionNode as Er, Node$1 as Et, ComponentNode as F, checkCompatEnabled as Fn, isSlotOutlet as Fr, PlainElementNode as Ft, DynamicSlotEntries as G, createForLoopParams as Gn, locStub as Gr, RawSourceMap as Gt, DirectiveArguments as H, createCompilerError as Hn, isVPre as Hr, RESOLVE_DIRECTIVE as Ht, CompoundExpressionNode as I, convertToBlock as In, isStaticArgOf as Ir, Position as It, DynamicSlotsExpression as J, createInterpolation as Jn, processFor as Jr, RootNode as Jt, DynamicSlotFnProperty as K, createFunctionExpression as Kn, noopDirectiveTransform as Kr, RenderSlotCall as Kt, ConditionalDynamicSlotNode as L, createArrayExpression as Ln, isStaticExp as Lr, Property as Lt, CompilerDeprecationTypes as M, buildDirectiveArgs as Mn, isMemberExpressionNode as Mr, PUSH_SCOPE_ID as Mt, CompilerError as N, buildProps as Nn, isReferencedIdentifier as Nr, ParentNode as Nt, CodegenOptions as O, advancePositionWithMutation as On, isInDestructureAssignment as Or, NodeTypes as Ot, CompilerOptions$1 as P, buildSlots as Pn, isSimpleIdentifier as Pr, ParserOptions as Pt, ExpressionNode as Q, createRoot as Qn, resolveComponentType as Qr, SequenceExpression as Qt, ConditionalExpression$1 as R, createAssignmentExpression as Rn, isStaticProperty as Rr, PropsExpression as Rt, CREATE_STATIC as S, UNREF as Sn, isCommentOrWhitespace as Sr, NORMALIZE_PROPS as St, CacheExpression as T, WITH_DIRECTIVES as Tn, isFnExpressionBrowser as Tr, Namespaces as Tt, DirectiveNode as U, createCompoundExpression as Un, isVSlot as Ur, RESOLVE_DYNAMIC_COMPONENT as Ut, DirectiveArgumentNode as V, createCallExpression as Vn, isText as Vr, RESOLVE_COMPONENT as Vt, DirectiveTransform as W, createConditionalExpression as Wn, isWhitespaceText as Wr, RESOLVE_FILTER as Wt, ElementTypes as X, createObjectProperty as Xn, processSlotOutlet as Xr, SSRCodegenNode as Xt, ElementNode as Y, createObjectExpression as Yn, processIf as Yr, SET_BLOCK_TRACKING as Yt, ErrorCodes as Z, createReturnStatement as Zn, registerRuntimeHelpers as Zr, SUSPENSE as Zt, CREATE_BLOCK as _, ServerOptions$1$1 as _i, TextCallNode as _n, hasDynamicKeyVBind as _r, ListDynamicSlotIterator as _t, MagicString as a, transformElement as ai, SlotsObjectProperty as an, errorMessages as ar, FunctionExpression$1 as at, CREATE_ELEMENT_VNODE as b, TransformOptions$2 as bi, TransformOptions as bn, injectProp as br, MemoExpression as bt, AttributeNode as c, transformOn as ci, TELEPORT as cn, findProp as cr, IS_MEMO_SAME as ct, BindingMetadata as d, unwrapTSNode as di, TO_HANDLER_KEY as dn, generateCodeFrame as dr, IfConditionalExpression as dt, toValidAssetId as ei, SlotFnBuilder as en, createSimpleExpression as er, ForCodegenNode as et, BindingTypes as f, validFirstIdentCharRE as fi, TS_NODE_TYPES as fn, getBaseTransformPreset as fr, IfNode as ft, CAPITALIZE as g, warnDeprecation as gi, TemplateTextChildNode as gn, getVNodeHelper as gr, KEEP_ALIVE as gt, CAMELIZE as h, walkIdentifiers as hi, TemplateNode as hn, getVNodeBlockHelper as hr, JSChildNode as ht, typescript_d_exports as i, transformBind as ii, SlotsObjectExpression as in, createVNodeCall as ir, ForRenderListExpression as it, CommentNode as j, baseParse as jn, isMemberExpressionBrowser as jr, POP_SCOPE_ID as jt, CodegenResult as k, assert as kn, isInNewExpression as kr, OPEN_BLOCK as kt, BASE_TRANSITION as l, transformVBindShorthand as li, TO_DISPLAY_STRING as ln, forAliasRE as lr, IS_REF as lt, BlockStatement as m, walkFunctionParams as mi, TemplateLiteral$1 as mn, getMemoedVNodeCall as mr, InterpolationNode as mt, AssetURLTagConfig as n, trackVForSlotScopes as ni, SlotOutletNode as nn, createTemplateLiteral as nr, ForNode as nt, ArrayExpression as o, transformExpression as oi, SourceLocation as on, extractIdentifiers as or, GUARD_REACTIVE_PROPS as ot, BlockCodegenNode as p, walkBlockDeclarations as pi, TemplateChildNode as pn, getConstantType as pr, IfStatement$1 as pt, DynamicSlotNode as q, createIfStatement as qn, processExpression as qr, ReturnStatement$1 as qt, SFCParseResult as r, transform as ri, SlotsExpression as rn, createTransformContext as rr, ForParseResult as rt, AssignmentExpression$1 as s, transformModel as si, StructuralDirectiveTransform as sn, findDir as sr, HoistTransform as st, Options as t, trackSlotScopes as ti, SlotFunctionExpression as tn, createStructuralDirectiveTransform as tr, ForIteratorExpression as tt, BaseElementNode as u, traverseNode as ui, TO_HANDLERS as un, generate as ur, IfBranchNode as ut, CREATE_COMMENT as v, UserConfig as vi, TextNode as vn, hasScopeRef as vr, ListDynamicSlotNode as vt, CREATE_VNODE as w, WITH_CTX as wn, isFnExpression as wr, Namespace as wt, CREATE_SLOTS as x, transform$1 as xi, TransformPreset as xn, isAllWhitespace as xr, NORMALIZE_CLASS as xt, CREATE_ELEMENT_BLOCK as y, ViteDevServer as yi, TransformContext as yn, helperNameMap as yr, MERGE_PROPS as yt, ConstantTypes as z, createBlockStatement as zn, isStaticPropertyKey as zr, RENDER_LIST as zt };