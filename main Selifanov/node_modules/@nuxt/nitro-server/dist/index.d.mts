...
import { P as CompilerOptions, _i as ServerOptions$1, bi as TransformOptions, n as AssetURLTagConfig, t as Options$5, vi as UserConfig, yi as ViteDevServer } from "./_chunks/libs/@vitejs/plugin-vue-jsx.mjs";
import { t as Options$6 } from "./_chunks/libs/@vitejs/plugin-vue.mjs";
...
import "./_chunks/libs/autoprefixer.mjs";
import "./_chunks/libs/@vue/compiler-dom.mjs";
...
import { t as LoaderOptions } from "./_chunks/libs/esbuild-loader.mjs";
import "./_chunks/libs/@types/pug.mjs";
import { t as VueLoaderOptions } from "./_chunks/libs/vue-loader.mjs";
...
import { CorsOptions, EventHandler, H3CorsOptions, H3Event } from "h3";
...
import { NuxtIslandContext, NuxtIslandResponse, NuxtLinkOptions, NuxtRenderHTMLContext } from "nuxt/app";
...
interface NuxtHooks {
   ...
   * @returns Promise
   */
  'components:dirs': (dirs: ComponentsOptions['dirs']) => HookResult$1;
  /**
   * Allows extending new components.
   * @param components The `components` array to push new items
   * @returns Promise
   */
  'components:extend': (components: Component$1[]) => HookResult$1;
  /**
   ...
   * @returns Promise
   */
  'build:error': (error: Error) => HookResult$1;
  /**
   ...
   * @returns Promise
   */
  'listen': (listenerServer: Server | Server$1, listener: any) => HookResult$1;
  /**
   ...
   * @returns Promise
   */
  'vite:compiled': () => HookResult$1;
  /**
   * Called before configuring the webpack compiler.
   * @param webpackConfigs Configs objects to be pushed to the compiler
   * @returns Promise
   */
  'webpack:config': (webpackConfigs: Configuration[]) => HookResult$1;
  /**
   * Allows to read the resolved webpack config
   * @param webpackConfigs Configs objects to be pushed to the compiler
   * @returns Promise
   */
  'webpack:configResolved': (webpackConfigs: Readonly<Configuration>[]) => HookResult$1;
  /**
   ...
   * @returns Promise
   */
  'rspack:config': (webpackConfigs: Configuration[]) => HookResult$1;
  /**
   * Allows to read the resolved webpack config
   * @param webpackConfigs Configs objects to be pushed to the compiler
   * @returns Promise
   */
  'rspack:configResolved': (webpackConfigs: Readonly<Configuration>[]) => HookResult$1;
  /**
   * Called right before compilation.
   * @param options The options to be added
   * @returns Promise
...
interface RuntimeConfig$1 extends RuntimeConfigNamespace {
...
interface NuxtConfig extends DeepPartial<Omit<ConfigSchema, 'components' | 'vue' | 'vite' | 'runtimeConfig' | 'webpack' | 'nitro'>> {
  ...
  runtimeConfig?: Overrideable<RuntimeConfig$1>;
