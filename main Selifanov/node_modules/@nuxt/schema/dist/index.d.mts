...
import { E as CompilerOptions, a as SerializableHead, h as KeepAliveProps, i as RenderSSRHeadOptions, n as DataKeys, r as GlobalAttributes, s as TransitionProps, t as AriaAttributes, u as AppConfig$1 } from "./_chunks/libs/@unhead/vue.mjs";
import { G as TransformOptions, H as ServerOptions$1, U as UserConfig, W as ViteDevServer, r as AssetURLTagConfig, t as Options$1 } from "./_chunks/libs/@vitejs/plugin-vue-jsx.mjs";
import { t as Options$2 } from "./_chunks/libs/@vitejs/plugin-vue.mjs";
import { n as Schema, r as SchemaDefinition, t as InputObject } from "./_chunks/libs/untyped.mjs";
...
import { t as Manifest } from "./_chunks/libs/vue-bundle-renderer.mjs";
...
interface NuxtHooks {
  ...
  * @returns Promise
  */
  "webpack:config": (webpackConfigs: Configuration$1[]) => HookResult;
  /**
  * Allows to read the resolved webpack config
  * @param webpackConfigs Configs objects to be pushed to the compiler
  * @returns Promise
  */
  "webpack:configResolved": (webpackConfigs: Readonly<Configuration$1>[]) => HookResult;
  /**
  ...
  * @returns Promise
  */
  "rspack:config": (webpackConfigs: Configuration$1[]) => HookResult;
  /**
  * Allows to read the resolved webpack config
  * @param webpackConfigs Configs objects to be pushed to the compiler
  * @returns Promise
  */
  "rspack:configResolved": (webpackConfigs: Readonly<Configuration$1>[]) => HookResult;
  /**
  * Called right before compilation.
  * @param options The options to be added
  * @returns Promise
