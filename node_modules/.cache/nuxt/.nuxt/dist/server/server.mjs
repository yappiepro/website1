import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, isRef, isReadonly, isShallow, isReactive, toRaw, watch, defineAsyncComponent, Suspense, Fragment, useSSRContext, mergeProps, withCtx, createVNode, resolveDynamicComponent, Transition, openBlock, createBlock, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { debounce } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/perfect-debounce/dist/index.mjs";
import { defu, defuFn } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/defu/dist/defu.mjs";
import { hash } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { klona } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/klona/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView, useRouter as useRouter$1 } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, withoutTrailingSlash, withLeadingSlash, withBase, withTrailingSlash, withoutBase, stringifyQuery } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1, resolveUnrefHeadInput } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/@unhead/vue/dist/index.mjs";
import { InferSeoMetaPlugin } from "@unhead/addons";
import { TemplateParamsPlugin } from "unhead/plugins";
import { titleCase, camelCase } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/scule/dist/index.mjs";
import { SchemaOrgUnheadPlugin, defineWebSite, defineWebPage } from "@unhead/schema-org/vue";
import { stringify, parse } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/devalue/index.js";
import { toRouteMatcher, createRouter as createRouter$1 } from "/Users/artemselifanov/qwen/лендинг ai/node_modules/radix3/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader } from "@iconify/vue";
import { ssrRenderTeleport, ssrRenderStyle, ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSuspense } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = { prerender: true }, $1 = {}, $2 = { redirect: "/sitemap_index.xml" };
  return (m, p) => {
    let r = [];
    ...
    if (p === "/") {
      ...
      r.unshift({ data: $1 });
    } else if (p === "/__sitemap__/pages.xml") {
      r.unshift({ data: $1 });
    } else if (p === "/__sitemap__/blog.xml") {
      r.unshift({ data: $1 });
    } else if (p === "/_nuxt") {
      r.unshift({ data: $1 });
    }
...
const component_45stubGHjVbVm6BYoUzPBFpntvCqnNCa809xQDfFWiKmMSuiw = {};
const _routes = [
  {
    name: "blog-cluster-slug",
    path: "/blog/cluster/:slug()",
    component: () => import("./_nuxt/_slug_-CDuGo-l-.js")
  },
  {
    name: "knowledge-post-id",
    path: "/knowledge/post/:id()",
    component: () => import("./_nuxt/_id_-Dx77pC7m.js")
  },
  {
    name: "admin-contacts",
    path: "/admin/contacts",
    component: () => import("./_nuxt/contacts--0lpi-J9.js")
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import("./_nuxt/_slug_-B7p5Gxq7.js")
  },
  {
    name: "knowledge-slug",
    path: "/knowledge/:slug()",
    component: () => import("./_nuxt/_slug_-CKgWojSX.js")
  },
  {
    name: "404",
    path: "/404",
    component: () => import("./_nuxt/404-DKD9eCLj.js")
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/index-Dlj_423W.js")
  },
  {
    name: "business",
    path: "/business",
    component: () => import("./_nuxt/business-BcKOpW4e.js")
  },
  {
    name: "consultation",
    path: "/consultation",
    component: () => import("./_nuxt/consultation-BtacCgAR.js")
  },
  {
    name: "cookie",
    path: "/cookie",
    component: () => import("./_nuxt/cookie-q38m396h.js")
  },
  {
    name: "knowledge",
    path: "/knowledge",
    component: () => import("./_nuxt/index-dLWm7NFv.js")
  },
  {
    name: "map",
    path: "/map",
    component: () => import("./_nuxt/map-Bb-gZZW7.js")
  },
  {
    name: "mentorship",
    path: "/mentorship",
    component: () => import("./_nuxt/mentorship-BgPKa4LB.js")
  },
  {
    name: "networking",
    path: "/networking",
    component: () => import("./_nuxt/networking-Don6wDbB.js")
  },
  {
    name: "networking-rules",
    path: "/networking-rules",
    component: () => import("./_nuxt/networking-rules-B-Am3fJP.js")
  },
  {
    name: "offer",
    path: "/offer",
    component: () => import("./_nuxt/offer-DQTKBWah.js")
  },
  {
    name: "offline",
    path: "/offline",
    component: () => import("./_nuxt/offline-QWQjksfw.js")
  },
  {
    name: "part1",
    path: "/part1",
    component: () => import("./_nuxt/part1-C7fJWP0E.js")
  },
  {
    name: "part2",
    path: "/part2",
    component: () => import("./_nuxt/part2-DCFFFe2y.js")
  },
  {
    name: "part3",
    path: "/part3",
    component: () => import("./_nuxt/part3-BKDuRC8l.js")
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-rdWXhrt4.js")
  },
  {
    name: "study",
    path: "/study",
    component: () => import("./_nuxt/study-BUyHCqJC.js")
  },
  {
    name: "test",
    path: "/test",
    component: () => import("./_nuxt/test-BNUD1GiI.js")
  },
  {
    name: "yappie",
    path: "/yappie",
    component: () => import("./_nuxt/yappie-CIRXJJKh.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-P5nh1mSb.js")
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/sitemap.xml",
    component: component_45stubGHjVbVm6BYoUzPBFpntvCqnNCa809xQDfFWiKmMSuiw
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-CVMvU1pR.js").then((r) => r["default"] || r.default || r));
...
const mode = "mount";
const nuxt_plugin_UFMCqFAmT_rT4NcMBSUgq5IuOGNlCK5IH_2sTbP0mGc = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
...
const font_fallback_inlining_plugin_server_Ws81Prt9Nl2CWJJFHbFcLowVk4saho6ynWp0RZ6s4Bs = /* @__PURE__ */ defineNuxtPlugin(() => {
  useHead({ style: [{ innerHTML: css + __INLINED_CSS__ }] });
});
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (isLoading.value) {
          _push2(`<div class="fixed top-0 left-0 right-0 z-[100] h-1 bg-gray-200"><div class="h-full bg-gradient-to-r from-blue-600 via-purple-500 to-blue-600 transition-all duration-300 ease-linear" style="${ssrRenderStyle({ width: progress.value + "%" })}"></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
_sfc_main$5.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/LoadingBar.vue");
...
const _sfc_main$4 = {
  __name: "LayoutCookieBanner",
  __ssrInlineRender: true,
  setup(__props) {
    const isVisible = ref(false);
    const isAccepted = ref(false);
    return (_ctx, _push, _parent, _attrs) => {
      if (isVisible.value && !isAccepted.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed bottom-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-md border-t border-gray-700 shadow-2xl" }, _attrs))} data-v-d9cc5df5><div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6" data-v-d9cc5df5><div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4" data-v-d9cc5df5><div class="flex-1" data-v-d9cc5df5><p class="text-sm sm:text-base text-gray-200 leading-relaxed" data-v-d9cc5df5> Мы используем файлы <strong data-v-d9cc5df5>cookies</strong> и сервис <strong data-v-d9cc5df5>Яндекс.Метрика</strong> для анализа посещаемости и улучшения работы сайта. Продолжая использовать сайт, вы соглашаетесь с нашей <a href="/cookie" class="text-violet-400 hover:text-violet-300 underline" data-v-d9cc5df5>политикой cookies</a>. </p></div><div class="flex items-center gap-3 flex-shrink-0" data-v-d9cc5df5><button class="px-5 py-2.5 text-sm font-semibold text-white bg-violet-600 hover:bg-violet-500 rounded-lg transition-all whitespace-nowrap" data-v-d9cc5df5> Принять все </button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/CookieBanner.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const CookieBanner = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-d9cc5df5"]]);
const _sfc_main$3 = {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/GoogleAnalytics.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const GoogleAnalytics = Object.assign(_sfc_main$3, { __name: "GoogleAnalytics" });
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(GoogleAnalytics, null, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C_ja6C01.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DnZllTqg.js"));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-wNVzjWGy.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
