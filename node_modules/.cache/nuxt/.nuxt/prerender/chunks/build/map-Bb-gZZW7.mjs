import __nuxt_component_0 from './index-CVMvU1pR.mjs';
import { defineComponent, ref, computed, mergeProps, unref, useSSRContext } from 'file:///Users/artemselifanov/qwen/%D0%BB%D0%B5%D0%BD%D0%B4%D0%B8%D0%BD%D0%B3%20ai/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrInterpolate } from 'file:///Users/artemselifanov/qwen/%D0%BB%D0%B5%D0%BD%D0%B4%D0%B8%D0%BD%D0%B3%20ai/node_modules/vue/server-renderer/index.mjs';
import { _ as _sfc_main$1 } from './Header-BFdqxWtr.mjs';
import { _ as _sfc_main$2 } from './BaseMobileMenu-sWAy4ryK.mjs';
import { _ as _sfc_main$3 } from './Footer-L6FSeQfO.mjs';
...
import 'file:///Users/artemselifanov/qwen/%D0%BB%D0%B5%D0%BD%D0%B4%D0%B8%D0%BD%D0%B3%20ai/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        { name: "description", content: "Работаю с клиентами по всей России и СНГ. Узнайте географию моего присутствия." },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50" }, _attrs))}>`);
      ...
      _push(`<main role="main"><section class="pt-32 pb-16 px-4 sm:px-6"><div class="max-w-7xl mx-auto text-center"><div class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-2xl shadow-sm mb-6">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "fa-solid:map",
        class: "w-4 h-4 text-blue-600"
      }, null, _parent));
      _push(`<span class="text-xs font-bold text-gray-700 uppercase tracking-wider">География</span></div><h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-gray-900 mb-6"> Карта присутствия </h1><p class="text-lg text-gray-600 max-w-2xl mx-auto"> Работаю с клиентами по всей России и СНГ. Основные направления деятельности отмечены на карте. </p></div></section><section class="pb-24 px-4 sm:px-6"><div class="max-w-7xl mx-auto"><div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-8 overflow-hidden"><div class="relative w-full" style="${ssrRenderStyle({ "padding-bottom": "62.1%" })}"><svg viewBox="0 0 1224.449 760.6203" class="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><g id="regions"><!--[-->`);
      ssrRenderList(unref(regions), (region) => {
        _push(`<path${ssrRenderAttr("id", region.id)}${ssrRenderAttr("d", region.path)}${ssrRenderAttr("name", region.name)} class="${ssrRenderClass([getRegionClass(region.id), "cursor-pointer transition-all duration-300 hover:opacity-80 stroke-white stroke-[0.5]"])}"></path>`);
      });
      _push(`<!--]--></g></svg>`);
      if (hoveredRegion.value) {
        _push(`<div class="absolute pointer-events-none z-20 px-3 py-2 bg-gray-900 text-white text-sm font-semibold rounded-lg shadow-lg whitespace-nowrap" style="${ssrRenderStyle({
          left: `${tooltipPosition.value.left}px`,
          top: `${tooltipPosition.value.top - 10}px`,
          transform: "translate(-50%, -100%)"
        })}">${ssrInterpolate(hoveredRegionName.value)} <div class="absolute top-full left-1/2 transform -translate-x-1/2 -mt-1"><div class="border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-gray-900"></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><p class="mt-4 text-center text-sm text-gray-500">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "fa-solid:hand-pointer",
        class: "w-4 h-4 inline mr-1"
      }, null, _parent));
      _push(` Нажмите на регион, чтобы увидеть информацию </p></div></div></section>`);
      if (selectedRegion.value) {
        _push(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm"><div class="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 sm:p-8 relative animate-in fade-in zoom-in duration-300"><button class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition-colors p-2 hover:bg-gray-100 rounded-full">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:x",
          class: "w-6 h-6"
        }, null, _parent));
        _push(`</button><div class="mb-6"><div class="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 border border-blue-100 rounded-xl mb-4">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa-solid:map-location-dot",
          class: "w-4 h-4 text-blue-600"
        }, null, _parent));
        _push(`<span class="text-xs font-bold text-blue-700 uppercase tracking-wider">Регион России</span></div><h2 class="text-2xl sm:text-3xl font-black text-gray-900">${ssrInterpolate(selectedRegionName.value)}</h2><p class="text-sm text-gray-500 mt-1">${ssrInterpolate(selectedRegionCode.value)}</p></div><div class="space-y-4"><div class="p-4 bg-gray-50 rounded-2xl border border-gray-100"><p class="text-gray-700">${ssrInterpolate(selectedRegionDescription.value)}</p></div><div class="grid grid-cols-2 gap-3"><div class="p-4 bg-blue-50 rounded-2xl border border-blue-100"><div class="text-2xl font-black text-blue-600">85+</div><div class="text-xs text-blue-700 mt-1">Регионов в РФ</div></div><div class="p-4 bg-green-50 rounded-2xl border border-green-100"><div class="text-2xl font-black text-green-600">170+</div><div class="text-xs text-green-700 mt-1">Народов</div></div></div></div><div class="mt-6 flex gap-3"><a href="https://t.me/artemselifanov" target="_blank" rel="noopener noreferrer" class="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-gray-900 hover:bg-gray-800 rounded-2xl transition-all hover:-translate-y-0.5">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa-brands:telegram",
          class: "w-4 h-4"
        }, null, _parent));
        _push(` Связаться </a><button class="px-6 py-3 text-sm font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-2xl transition-all"> Закрыть </button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<section class="pb-24 px-4 sm:px-6"><div class="max-w-6xl mx-auto"><div class="grid md:grid-cols-3 gap-6"><div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center"><div class="text-4xl font-black text-blue-600 mb-2">85+</div><div class="text-sm text-gray-600">Регионов присутствия</div></div><div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center"><div class="text-4xl font-black text-blue-600 mb-2">50+</div><div class="text-sm text-gray-600">Городов России</div></div><div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center"><div class="text-4xl font-black text-blue-600 mb-2">24/7</div><div class="text-sm text-gray-600">Поддержка клиентов</div></div></div></div></section></main>`);
...
//# sourceMappingURL=map-Bb-gZZW7.mjs.map
