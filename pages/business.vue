        ...
        <div class="h-14 md:h-16 flex items-center">
          ...
          <div :class="[
            ...
            <a href="/" class="group flex items-center gap-3">
              <NuxtImg src="/reference/business.jpg" format="webp" quality="50" sizes="20px sm:28px md:40px" alt="Бизнес Сетка — логотип закрытого клуба предпринимателей" class="w-10 h-10 rounded-lg" />
      ...
      <div class="max-w-[1600px] mx-auto">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
          <div class="flex items-center gap-3">
            <NuxtImg src="/reference/business.jpg" format="webp" quality="50" sizes="24px md:32px" alt="Бизнес Сетка — логотип" class="w-6 h-6 rounded-md" />
