...
useSeoMeta({
  ...
  description:
    'Закрытый клуб предпринимателей и экспертов. Мастермайнд-группы, бизнес-разборы, нетворкинг. 250 участников. Артём Селифанов — Бизнес Сетка.',
  keywords:
...
const faqs = [
  {
    ...
    answer:
      '«Бизнес Сетка» — это закрытый клуб предпринимателей и экспертов, объединяющий 250 участников. Сообщество создано для тех, кто хочет масштабировать бизнес через нетворкинг, разборы реальных кейсов и мастермайнд-группы. В отличие от открытых бизнес-конференций, здесь нет случайных людей — каждый участник проходит отбор и приходит с конкретными задачами роста.',
  },
  {
    question: 'Что такое мастермайнд и чем он полезен для предпринимателя?',
    answer:
      'Мастермайнд — это формат групповой работы, при котором 4–8 предпринимателей регулярно встречаются и разбирают задачи каждого участника. В отличие от коучинга (работа с одним специалистом) или курса (обучение по шаблону), в мастермайнде вы получаете коллективный интеллект людей, которые уже решали похожие задачи в своём бизнесе. Это один из самых эффективных инструментов для масштабирования малого и среднего бизнеса.',
  },
  {
    question: 'Как проходит мастермайнд в «Бизнес Сетке»? Формат и расписание?',
    answer:
      'Мастермайнд включает 4 онлайн-встречи по 2+ часа. На каждой сессии разбирается бизнес-задача одного из участников: текущая ситуация → ключевые ограничения → решения от группы → конкретные шаги. Каждый участник получает персональный разбор своего проекта плюс постоянную обратную связь в групповом чате.',
  },
  {
    question: 'Сколько стоит участие в мастермайнде и что в него входит?',
    answer:
      'Стоимость участия — 37 500 ₽. В программу входит: 4 групповые онлайн-встречи по 2+ часа, персональный разбор вашего бизнеса и стратегии, доступ в закрытый чат участников, база знаний сообщества и рекомендации по развитию. Количество мест в группе ограничено — для фиксации места напишите в Telegram.',
  },
  {
    question: 'Кто участвует в мастермайнде — какие бизнесы и ниши?',
    answer:
      'В сообществе собраны предприниматели из разных ниш: IT-бизнес, консалтинг, производство, онлайн-образование, e-commerce, сервисный бизнес. Разнообразие ниш — это преимущество: решения из одной отрасли часто неожиданно хорошо работают в другой. Единственный критерий отбора — готовность делиться опытом и реально работать над своим бизнесом.',
  },
  {
    question: 'Чем мастермайнд в «Бизнес Сетке» отличается от бизнес-клубов и акселераторов?',
    answer:
      'Большинство бизнес-клубов — это нетворкинг-встречи без системной работы над вашим бизнесом. Акселераторы заточены под стартапы с инвестиционной моделью. «Бизнес Сетка» — практическая работа в мини-группе без лишней теории: каждая встреча заканчивается конкретными действиями для каждого участника. Малый формат группы (4–8 человек) обеспечивает глубину проработки, которую невозможно получить в большом клубе.',
  },
  {
    question: 'Что такое бизнес-разбор и как на него попасть?',
    answer:
      'Бизнес-разбор — это разовая экспертная сессия, на которой Артём и участники сообщества анализируют ваш конкретный бизнес-кейс: стратегию, сайт, воронку продаж или маркетинг. Уже проведено 3 разбора. Попасть на разбор можно как участнику сообщества. Напишите в Telegram @artemselifanov с кратким описанием вашего запроса.',
  },
  {
    question: 'Как стать участником «Бизнес Сетки»?',
    answer:
      'Шаг 1: Вступите в Telegram-сообщество по кнопке на сайте — это бесплатно. Шаг 2: Познакомьтесь с участниками в чате. Шаг 3: Если хотите участвовать в мастермайнде — напишите Артёму в Telegram для короткого знакомства (15 минут). Шаг 4: После подтверждения — оплата и старт в ближайшей группе. Текущая загрузка группы: уточняйте при записи.',
  },
  {
    question: 'Когда стартует следующая мастермайнд-группа?',
    answer:
      'Группы стартуют по мере набора участников. Ближайший старт — уточняйте в Telegram. Рекомендуем подавать заявку заранее: количество мест ограничено 8 участниками в группе. Ранним участникам — приоритет при формировании группы и фиксация текущей цены.',
  },
  {
    question: 'Какой результат можно ожидать от участия в мастермайнде?',
    answer:
      'Участники отмечают три ключевых эффекта: (1) решение застрявших задач — за 4 встречи разбирается 2–4 конкретных бизнес-проблем каждого участника; (2) расширение круга — партнёры и клиенты из числа участников сообщества; (3) фокус и темп — групповая динамика не даёт откладывать важные решения. Конкретные цифры зависят от вашего бизнеса и вовлечённости.',
  },
  {
    question: 'Возможен ли возврат, если формат не подошёл?',
    answer:
      'Да. Если после первой сессии мастермайнда вы понимаете, что формат не соответствует вашим ожиданиям — возврат рассматривается индивидуально. Напишите напрямую: @artemselifanov. Мы заинтересованы в том, чтобы каждый участник получал ценность, а не просто платил за место.',
  },
  {
    question: 'Можно ли участвовать в «Бизнес Сетке» и в «Нескучном Нетворкинге» одновременно?',
    answer:
      'Да, и многие участники именно так и делают. «Нескучный Нетворкинг» фокусируется на развитии личного бренда и контент-маркетинге в социальных сетях. «Бизнес Сетка» — на бизнес-задачах: стратегия, масштабирование, партнёрства. Форматы отлично дополняют друг друга: сильный личный бренд усиливает нетворкинг в бизнес-сообществе.',
  },
]
...
<template>
  <div class="min-h-screen bg-white text-gray-900 antialiased">
    ...
    >
      <div class="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8">
        <div class="h-14 md:h-16 flex items-center">
          ...
          <div :class="['transition-all duration-300', scrolled ? 'hidden' : 'block md:block']">
            <a href="/" class="group flex items-center gap-3">
              <img
                src="/reference/business.webp"
                quality="75"
                alt="Бизнес Сетка — логотип закрытого клуба предпринимателей"
          ...
          >
            ...
            <a
              href="/yappie"
              class="px-4 py-2 text-sm text-violet-600 hover:text-violet-700 rounded-lg transition-all"
              >Веб-разработка</a
            >
          </nav>
    ...
    <main role="main">
      ...
      <section
        id="bento-section"
        class="pt-24 md:pt-32 pb-16 px-4 sm:px-6 bg-gradient-to-br from-gray-50 to-white relative"
      >
        <div class="max-w-[1600px] mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <!-- Identity -->
            <div
              class="md:col-span-1 lg:col-span-1 p-6 md:p-8 bg-white rounded-3xl border border-gray-200 hover:border-purple-200 hover:shadow-lg hover:shadow-purple-100/50 transition-all duration-300"
            >
              ...
              <div class="relative w-full h-8 mb-3">
                <div class="absolute inset-0 bg-gray-100 rounded-full overflow-hidden">
                  <div
                    class="absolute left-0 top-0 h-full w-0 bg-gradient-to-r from-purple-600 to-purple-400 rounded-full progress-bar"
                  ></div>
                </div>
                <span
                  class="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-semibold text-white"
                  >развивать бизнес вместе</span
                >
              </div>
            ...
            <!-- Navigation -->
            <div
              class="md:col-span-1 lg:col-span-2 p-6 md:p-8 bg-white rounded-3xl border border-gray-200 hover:border-purple-200 hover:shadow-lg transition-all duration-300"
            >
              <nav class="flex flex-wrap items-center justify-center gap-6 md:gap-12 h-full">
                <a href="#membership" class="group flex items-center gap-2">
                  <span
                    class="text-lg md:text-xl font-bold text-gray-900 group-hover:text-purple-600 transition-colors"
                    >УЧАСТИЕ</span
                  >
                  <ArrowRight
                    class="w-4 h-4 text-gray-300 group-hover:text-purple-600 transition-colors opacity-0 group-hover:opacity-100"
                  />
                </a>
            ...
            <!-- CTA -->
            <div
              class="md:col-span-1 lg:col-span-1 p-6 md:p-8 bg-white rounded-3xl border border-gray-200 hover:border-purple-200 hover:shadow-lg transition-all duration-300 group cursor-pointer"
              @click="window.open('https://t.me/+mFUh7ye6U6NjNzli', '_blank')"
            >
              <div class="flex items-center justify-between h-full">
                <div>
                  <span class="text-[10px] font-semibold tracking-wider text-gray-400"
                    >ДЕЙСТВИЕ</span
                  >
                  <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mt-2">ВСТУПИТЬ</h3>
                </div>
                <ArrowRight
                  class="w-6 h-6 text-gray-300 group-hover:text-purple-600 group-hover:translate-x-1 transition-all"
                />
              </div>
            </div>
            ...
            <!-- Metric -->
            <div
              class="md:col-span-1 lg:col-span-1 p-6 md:p-8 bg-gradient-to-br from-purple-600 via-purple-500 to-purple-400 rounded-3xl text-white hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-300"
            >
            ...
            >
              ...
              <div class="mt-4">
                <h2
                  class="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-400 leading-none"
                >
                  БЫСТРЫЙ<br />РОСТ
                </h2>
                <p class="text-gray-600 mt-4 text-base md:text-lg max-w-md">
                  Операционная система для современных бизнес-сообществ
                </p>
              </div>
            </div>
            ...
            <!-- Focus -->
            <div
              class="md:col-span-1 lg:col-span-1 p-6 md:p-8 bg-white rounded-3xl border border-gray-200 hover:border-purple-200 hover:shadow-lg transition-all duration-300 overflow-hidden relative min-h-[200px] md:min-h-[250px]"
            >
              <span class="text-[10px] font-semibold tracking-wider text-gray-400">ФОКУС</span>
              <div class="absolute inset-0 overflow-hidden">
                <div
                  class="absolute bottom-3 right-3 w-9 h-9 md:w-12 md:h-12 bg-gradient-to-br from-purple-500 to-purple-300 rounded-full bounce-ball"
                ></div>
              </div>
              <span class="text-[10px] font-semibold tracking-wider text-gray-400 mt-auto block"
                >АБСТРАКТНАЯ ЛОГИКА</span
              >
            </div>

            <!-- Connect -->
            <div
              class="md:col-span-1 lg:col-span-1 p-6 md:p-8 bg-white rounded-3xl border border-gray-200 hover:border-purple-200 hover:shadow-lg transition-all duration-300"
            >
              ...
              <div class="flex flex-wrap gap-2 mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="px-3 py-1.5 text-xs font-semibold text-gray-700 bg-gray-100 hover:bg-purple-100 hover:text-purple-700 rounded-full transition-all border border-gray-200"
                  >Telegram</a
                >
                <a
                  href="https://max.ru/join/SFsv9-wXr61buZwRkTSUm74ablM_yss3RXWimOOmJtU"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="px-3 py-1.5 text-xs font-semibold text-gray-700 bg-gray-100 hover:bg-green-100 hover:text-green-700 rounded-full transition-all border border-gray-200"
                  >Max</a
                >
                <a
                  href="https://vk.com/karelbusiness"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="px-3 py-1.5 text-xs font-semibold text-gray-700 bg-gray-100 hover:bg-blue-100 hover:text-blue-700 rounded-full transition-all border border-gray-200"
                  >VK</a
                >
              </div>
              <a
                href="mailto:a9535487323@yandex.ru"
                class="mt-4 block text-sm text-gray-500 hover:text-purple-600 transition-colors"
                >a9535487323@yandex.ru</a
              >
            </div>

            <!-- Purple spacer -->
            <div
              class="md:col-span-1 lg:col-span-2 p-6 md:p-8 bg-gradient-to-br from-purple-600 to-purple-500 rounded-3xl hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-300 flex items-end justify-between"
            >
              <div class="text-white">
                <span class="text-[10px] font-semibold tracking-wider text-purple-200"
                  >СООБЩЕСТВО</span
                >
            ...
            >
              ...
              <h3
                class="text-lg md:text-xl font-bold text-gray-900 mt-3 group-hover:text-purple-600 transition-colors"
              >
                ПОЛУЧИТЬ<br />РАННИЙ ДОСТУП
              </h3>
              <div class="mt-4">
                <div class="relative w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div
                    class="absolute left-0 top-0 h-full w-[40%] bg-gradient-to-r from-purple-600 to-purple-400 rounded-full"
                  ></div>
                </div>
                <span class="text-xs font-semibold text-purple-600 mt-2 block"
                  >40% мест занято</span
                >
              </div>
            </div>
            ...
            >
              ...
              <h3
                :class="[
                  ...
                  direction.highlighted ? 'text-white' : 'text-gray-900',
                ]"
              >
                {{ direction.title }}
              </h3>
              <p
                :class="[
                  'text-sm mb-4',
                  direction.highlighted ? 'text-purple-100' : 'text-gray-600',
                ]"
              >
              ...
              <div
                v-if="direction.price"
                :class="[
                  'mb-4 p-4 rounded-2xl',
                  direction.highlighted ? 'bg-white/10' : 'bg-purple-50',
                ]"
              >
                <div
                  :class="[
                    'text-2xl md:text-3xl font-bold',
                    direction.highlighted ? 'text-white' : 'text-purple-600',
                  ]"
                >
                  {{ direction.price }}
                </div>
                <div
                  :class="['text-xs', direction.highlighted ? 'text-purple-200' : 'text-gray-500']"
                >
                  {{ direction.period }}
                </div>
              </div>
              ...
              <ul :class="['space-y-2']">
                <li
                  v-for="(feature, i) in direction.features"
                  :key="i"
                  :class="[
                ...
                >
                  <CheckCircle
                    :class="[
                      ...
                      direction.highlighted ? 'text-white/60' : 'text-purple-400',
                    ]"
                  />
                  <span>{{ feature }}</span>
                </li>
      ...
      <section class="py-16 md:py-24 px-4 sm:px-6 bg-white">
        <div class="max-w-[1600px] mx-auto">
          <div class="text-center mb-12">
            <span class="text-xs font-semibold tracking-wider text-purple-600"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
              class="p-6 md:p-8 bg-white rounded-3xl border-2 border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-300"
            >
              ...
              <p class="text-gray-600 text-sm">
                Пишешь в Telegram — коротко о себе и своём проекте. Мы отвечаем в течение 24 часов.
              </p>
            </div>
            ...
            >
              ...
              <p class="text-gray-600 text-sm">
                15-минутный разговор для знакомства и проверки того, что формат подходит под твои
                задачи.
              </p>
            </div>
            ...
            >
              ...
              <p class="text-gray-600 text-sm">
                Оплата → доступ в закрытый чат → стартовая встреча группы.
              </p>
            </div>
            ...
            >
              ...
              <p class="text-gray-600 text-sm">
                4 сессии по 2+ часа. Разбор участника, обратная связь от группы, конкретные шаги.
              </p>
            </div>
          </div>
        </div>
      ...
      <section class="py-16 md:py-24 px-4 sm:px-6 bg-gray-50">
        <div class="max-w-[1600px] mx-auto">
          <div class="text-center mb-12">
            ...
            >
            <h2 class="text-3xl md:text-5xl font-bold text-gray-900 mt-3">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
              class="p-6 md:p-8 bg-white rounded-3xl border-2 border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-300"
            >
              <p class="text-gray-700 text-sm md:text-base leading-relaxed mb-4 italic">
                «За 2 месяца мастермайнда я пересмотрел юнит-экономику своего продукта и нашёл узкое
                место, которое тормозило масштабирование. Группа дала взгляд со стороны, который я
                не мог получить внутри команды»
              </p>
            ...
            >
              <p class="text-gray-700 text-sm md:text-base leading-relaxed mb-4 italic">
                «Ожидал полезных знакомств — получил партнёра по бизнесу. Нетворкинг здесь работает
                иначе: не визитки, а реальные совместные проекты»
              </p>
              <div class="border-t-2 border-gray-200 pt-4">
            ...
            >
              <p class="text-gray-700 text-sm md:text-base leading-relaxed mb-4 italic">
                «Групповая динамика мастермайнда — это мощно. Когда 6 предпринимателей смотрят на
                твою задачу, находятся решения, до которых ты бы сам не дошёл ещё год»
              </p>
              <div class="border-t-2 border-gray-200 pt-4">
        ...
        <div class="max-w-3xl mx-auto">
          ...
          <div class="space-y-3">
            ...
            >
              ...
              >
                <span class="text-sm md:text-base font-semibold text-gray-900 pr-4">{{
                  faq.question
                }}</span>
                <ChevronDown
                  :class="[
                    'w-5 h-5 text-gray-400 transition-transform flex-shrink-0',
                    activeFaqIndex === index ? 'rotate-180 text-purple-600' : '',
                  ]"
                />
              </button>
              <div
      ...
      <section
        id="ventures"
        class="py-16 md:py-24 px-4 sm:px-6 bg-gradient-to-br from-purple-600 via-purple-500 to-purple-400"
      >
