...
useSeoMeta({
  title: 'Личный бренд, который приносит клиентов из соцсетей',
  description: 'Помогаю экспертам и предпринимателям получать клиентов из соцсетей через контент-маркетинг. Позиционирование, личный бренд, Telegram.',
  ...
  robots: 'index, follow',
  ogTitle: 'Личный бренд, который приносит клиентов из соцсетей',
  ogDescription: 'Помогаю экспертам и предпринимателям получать клиентов из соцсетей через контент-маркетинг. Позиционирование, личный бренд, Telegram.',
  ogType: 'website',
  ogLocale: 'ru_RU',
  ogUrl: 'https://artemselifanov.ru',
  ogImage: 'https://artemselifanov.ru/reference/openGraph/opengraph_index.webp',
  twitterCard: 'summary_large_image',
  twitterTitle: 'Личный бренд, который приносит клиентов из соцсетей',
  twitterDescription: 'Помогаю экспертам и предпринимателям получать клиентов из соцсетей через контент-маркетинг. Позиционирование, личный бренд, Telegram.',
