<template>
  <div class="min-h-screen bg-white text-gray-900 antialiased overflow-x-hidden">
    ...
    <main role="main">
        ...
        <div class="max-w-7xl mx-auto w-full relative z-10">
          <div class="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div class="lg:col-span-8">
              <h1
                class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.05] mb-6 text-balance"
              >
              ...
              <div class="flex flex-wrap gap-4 mb-10">
                ...
                >
                  <img src="/max-logo.svg" alt="Max" class="w-5 h-5 brightness-0 invert" />
                  Max
                </a>
              </div>
      ...
      <!-- 8. ВОЗРАЖЕНИЯ -->
      <section id="objections" class="py-16 md:py-24 lg:py-32 px-4 sm:px-6 border-t border-gray-100">
        <div class="max-w-4xl mx-auto">
          <div class="text-center mb-12">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight mb-4">Честные ответы на возражения</h2>
            <p class="text-lg text-gray-600">Которые мне часто задают</p>
          </div>
