        ...
        <div class="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div class="lg:col-span-8">
            ...
            <p class="text-base md:text-lg text-gray-600 leading-relaxed mb-8 max-w-2xl">
              Помогаю консультантам, коучам и предпринимателям сформулировать своё позиционирование, упаковать экспертизу и выстроить систему, где личный бренд работает на привлечение клиентов — без хаоса и бесконечного постинга.
            </p>
              ...
              <div class="relative w-full max-w-sm mx-auto">
                <div class="flex items-end justify-center gap-[6.5px]">
                  ...
                  <div class="w-[50px] sm:w-[70px] md:w-[90px] aspect-[9/19] rounded-[12px] overflow-hidden shadow-xl" data-position="left-2">
                    <img src="/reference/IMG_7084.webp" alt="Дзен" class="w-full h-full object-cover" loading="lazy" />
                  </div>

                  <!-- Левое фото 1 (Сетка) -->
                  <div class="w-[55px] sm:w-[75px] md:w-[100px] aspect-[9/19] rounded-[12px] overflow-hidden shadow-xl" data-position="left-1">
                    <img src="/reference/IMG_7082.webp" alt="Сетка" class="w-full h-full object-cover" loading="lazy" />
                  </div>
                  ...
                  <div class="w-[60px] sm:w-[85px] md:w-[110px] aspect-[9/19] rounded-[12px] overflow-hidden shadow-xl" data-position="center">
                    <img src="/reference/IMG_7089.webp" alt="Площадка" class="w-full h-full object-cover" fetchpriority="high" />
                  </div>
                  ...
                  <div class="w-[55px] sm:w-[75px] md:w-[100px] aspect-[9/19] rounded-[12px] overflow-hidden shadow-xl" data-position="right-1">
                    <img src="/reference/IMG_7083.webp" alt="TenChat" class="w-full h-full object-cover" loading="lazy" />
                  </div>
                  ...
                  <div class="w-[50px] sm:w-[70px] md:w-[90px] aspect-[9/19] rounded-[12px] overflow-hidden shadow-xl" data-position="right-2">
                    <img src="/reference/IMG_7090.webp" alt="Площадка" class="w-full h-full object-cover" loading="lazy" />
                  </div>
                </div>
              </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div class="animate-on-scroll">
            ...
            <div class="space-y-5 text-gray-600 leading-relaxed">
              <p class="text-lg">Работаю с теми, кто продаёт свою экспертизу: консультанты, коучи, наставники, владельцы бизнеса.</p>
              <p class="text-lg">Моя задача — не писать за вас посты. Моя задача — помочь вам понять, кто вы, для кого работаете и чем отличаетесь от других, а затем упаковать это в систему, где личный бренд стабильно приводит заявки.</p>
              <p class="text-lg font-medium text-gray-900">Опыт в бизнес-консалтинге позволяет мне думать категориями вашей прибыли, а не просто роста подписчиков.</p>
            </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div class="card-animate group p-8 bg-white border-2 border-gray-200 rounded-[2rem] hover:border-blue-300 transition-all hover:-translate-y-2">
            ...
            <div class="mb-6">
              ...
              <p class="text-sm text-gray-600">Разберёмся, что мешает вашему каналу расти — за 30 минут</p>
            </div>
          ...
          <div class="card-animate delay-200 group p-8 bg-white border-2 border-gray-200 rounded-[2rem] hover:border-blue-300 transition-all hover:-translate-y-2">
            ...
            <div class="mb-6">
              ...
              <p class="text-sm text-gray-600">Глубокий разбор позиционирования и конкретный план действий</p>
            </div>
        ...
        <div class="space-y-4">
          <div v-for="(faq, index) in faqs" :key="index"
            ...
            >
              ...
              <svg
                :class="['w-5 h-5 text-gray-500 flex-shrink-0 transition-transform duration-300', openFaqIndex === index ? 'rotate-180' : '']"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div class="w-full lg:w-[40%] space-y-6">
            ...
            <div class="space-y-5">
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">Ваши данные под защитой и не передаются третьим лицам</p>
                </div>
              </div>
            ...
            <div class="mt-10 pt-8 border-t border-gray-200">
              ...
              <div class="flex flex-wrap gap-3">
                <a href="https://t.me/artemselifanov" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm font-medium transition-all shadow-md hover:shadow-lg">
                  <Icon name="fa-brands:telegram" class="w-4 h-4" />
                  Telegram
                </a>
                <a href="mailto:a9535487323@yandex.ru" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg text-sm font-medium transition-all shadow-md hover:shadow-lg">
...
useSeoMeta({
  ...
  description: 'Помогаю экспертам и предпринимателям выйти на высокий чек и стабильный поток клиентов через личный бренд. Упаковка, стратегия, Telegram. Работаю с 2021 года.',
  keywords: 'личный бренд, продвижение эксперта, контент-маркетинг, нетворкинг, позиционирование эксперта, Артём Селифанов, Telegram-канал, упаковка профиля, стратегия продвижения, личный бренд телеграм, продвижение в telegram, личный бренд для предпринимателя, упаковка эксперта, контент стратегия, личный маркетинг, продвижение услуг, эксперт телеграм, личный бренд с нуля, монетизация блога, личный бренд 2026, нетворкинг для бизнеса, личный бренд психолог, личный бренд юрист, личный бренд маркетолог, продвижение консультанта, личный бренд коуч, telegram продвижение, личный бренд цена, упаковка соцсетей, позиционирование бренда, личный бренд стратегия, контент план телеграм, личный бренд стоимость',
  author: 'Артём Селифанов',
  robots: 'index, follow',
  ogTitle: 'Артём Селифанов — Личный бренд для экспертов и предпринимателей | Клиенты и высокий чек',
  ogDescription: 'Помогаю экспертам и предпринимателям выйти на высокий чек и стабильный поток клиентов через личный бренд. Упаковка, стратегия, Telegram. Работаю с 2021 года.',
  ogType: 'website',
  ogLocale: 'ru_RU',
  ogUrl: 'https://artemselifanov.ru',
  ogImage: 'https://artemselifanov.ru/reference/openGraph/opengraph_index.webp',
  twitterCard: 'summary_large_image',
  twitterTitle: 'Артём Селифанов — Личный бренд для экспертов и предпринимателей | Клиенты и высокий чек',
  twitterDescription: 'Помогаю экспертам и предпринимателям выйти на высокий чек и стабильный поток клиентов через личный бренд. Упаковка, стратегия, Telegram. Работаю с 2021 года.',
...
const targetAudience = [
  {
    ...
    description: 'Клиенты торгуются по цене, а вы не знаете, как обосновать чек — пора выстроить личный бренд, который продаёт за вас'
  },
  {
    icon: 'briefcase',
    title: 'Предприниматели (услуги)',
    description: 'Реклама съедает бюджет, а сарафан нестабилен — личный бренд создаёт поток клиентов, который не зависит от рекламного кабинета'
  },
  {
    icon: 'user-tie',
    title: 'Специалисты',
    description: 'Маркетологи, юристы, психологи — вы отличный специалист, но клиенты об этом не знают. Личный бренд делает вашу экспертность видимой для нужных людей'
  }
]
