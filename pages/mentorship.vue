        ...
        <div class="max-w-7xl mx-auto w-full relative z-10">
          <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-gray-600 leading-relaxed mb-8 max-w-2xl mx-auto">
              5 сессий — от нуля до системы, которая приносит клиентов. За месяц работы один на один
              мы выстроим систему, которая работает — даже если сейчас у вас ноль подписчиков.
            </p>
        ...
        <div class="w-full flex flex-col lg:flex-row justify-center gap-6 lg:gap-8">
          ...
          <div class="w-full lg:w-[40%] space-y-6">
            ...
            <p class="text-lg text-gray-600 leading-relaxed">
              Напишите мне в Telegram или на почту — обсудим ваш опыт, цели и я
  ...
  meta: [
    {
      name: 'description',
      content:
        '5 сессий 1-на-1 по запуску блога за 35 000 ₽. От позиционирования до первых клиентов. Персональная работа + поддержка в чате.',
    },
    {
      name: 'keywords',
      content:
        'менторство блог, запуск блога ментор, персональная работа, блог с нуля, клиенты из блога, Telegram канал',
    },
...
useSeoMeta({
  ...
  ogDescription:
    '5 сессий 1-на-1 по запуску блога за 35 000 ₽. От позиционирования до первых клиентов.',
  ogType: 'website',
