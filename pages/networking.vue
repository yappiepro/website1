...
const valueItems = [
  {
    ...
    description:
      'Обмен опытом с другими участниками, разбор реальных кейсов и поддержка от тех, кто уже прошёл этот путь',
  },
  {
    icon: 'Check',
    title: 'Честность',
  ...
  },
  {
    ...
    description:
      'Блог рассматривается как бизнес-инструмент для продаж и влияния, а не просто дневник',
  },
  {
    icon: 'Zap',
    title: 'Результат',
      ...
      <div class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
        <div class="h-14 md:h-16 flex items-center">
          ...
          <div class="hidden md:flex items-center justify-end shrink-0">
            <a
              href="https://t.me/+dL4aVzBkems0MTMy"
              target="_blank"
    ...
    <main role="main">
      ...
      >
        <div class="max-w-[1400px] mx-auto">
          ...
          <div
            class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 md:mb-12 pb-4 border-b-2 border-black"
          >
            <div class="text-xs">
              <span class="uppercase tracking-wider">ID ПРОЕКТА: НН-2026</span>
              <span class="mx-3">//</span>
              <span class="uppercase tracking-wider"
                >ИНСТРУМЕНТЫ: СЕТКА, TENCHAT, TELEGRAM, КОНТЕНТ</span
              >
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-[2fr_1fr] gap-8 md:gap-12 items-start">
            <div>
              ...
              <h1
                class="text-3xl md:text-4xl lg:text-5xl font-black leading-[1.2] tracking-tight mb-6"
              >
            ...
            <div class="md:pl-8 md:border-l-2 border-black">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center justify-center w-full mt-6 font-medium px-6 py-4 bg-[#EA6D3A] text-white hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] transition-all duration-200 uppercase tracking-wider text-sm"
              >
          ...
          <!-- Статистика -->
          <div
            class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-12 md:mt-16 pt-8 md:pt-12 border-t-2 border-black"
          >
            <div>
            ...
            <div>
              ...
              <div class="text-xs uppercase tracking-wider mt-1 text-gray-600">
                Участников в чате
              </div>
            </div>
            <div>
      ...
      <section
        id="value"
        class="py-12 md:py-20 px-4 md:px-6 border-b-2 border-black animate-on-scroll"
      >
        <div class="max-w-[1400px] mx-auto">
          ...
          >
            ...
            <div class="relative w-full h-full">
              ...
              <div
                ...
                :class="[index === activeValueCardIndex ? 'opacity-100 z-20' : 'opacity-0 z-10']"
              >
                <div class="w-14 h-14 border-2 border-black flex items-center justify-center mb-4">
                  <MessageCircle
                    v-if="item.icon === 'MessageCircle'"
                    class="w-7 h-7 text-[#EA6D3A]"
                  />
                  <Check v-else-if="item.icon === 'Check'" class="w-7 h-7 text-[#EA6D3A]" />
                  <TrendingUp
                    v-else-if="item.icon === 'TrendingUp'"
                    class="w-7 h-7 text-[#EA6D3A]"
                  />
          ...
          <div class="hidden md:grid md:grid-cols-2 gap-4">
            ...
            <div
              class="row-span-2 border-2 border-black p-8 bg-white hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] transition-all duration-200"
            >
              <div class="w-16 h-16 border-2 border-black flex items-center justify-center mb-6">
                <MessageCircle class="w-8 h-8 text-[#EA6D3A]" />
              </div>
              <h3 class="text-2xl font-bold uppercase tracking-wider mb-3">
                {{ valueItems[0].title }}
              </h3>
      ...
      >
        <div class="max-w-[1400px] mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div
              class="border-2 border-black bg-white p-6 hover:shadow-[6px_6px_0px_0px_rgba(234,109,58,1)] hover:translate-x-[-3px] hover:translate-y-[-3px] transition-all duration-200"
            >
              <span class="text-5xl md:text-6xl font-black text-[#EA6D3A] block mb-4">01</span>
              <h3 class="text-lg md:text-xl font-bold uppercase tracking-wider mb-2">
                Вступаешь в сообщество
              </h3>
              <p class="text-sm text-gray-700 leading-relaxed">
                Нажимаешь кнопку → попадаешь в Telegram-чат с 130+ участниками
              </p>
            </div>
            ...
            >
              ...
              <h3 class="text-lg md:text-xl font-bold uppercase tracking-wider mb-2">
                Знакомишься и включаешься
              </h3>
              <p class="text-sm text-gray-700 leading-relaxed">
                Представляешься в чате, читаешь базу знаний, знакомишься с участниками
              </p>
            </div>
            ...
            >
              ...
              <h3 class="text-lg md:text-xl font-bold uppercase tracking-wider mb-2">
                Выбираешь свой формат
              </h3>
              <p class="text-sm text-gray-700 leading-relaxed">
                Бесплатное комьюнити, консультация, менторство или мастермайнд — в зависимости от
                твоих задач
              </p>
            </div>
            ...
            >
              ...
              <p class="text-sm text-gray-700 leading-relaxed">
                Публикуешь контент, получаешь обратную связь, масштабируешь аудиторию и продажи
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        id="audience"
        class="py-12 md:py-20 px-4 md:px-6 border-b-2 border-black bg-gray-50 animate-on-scroll"
      >
        <div class="max-w-[1400px] mx-auto">
          ...
          <div class="space-y-4">
            ...
            >
              <div class="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
                ...
                <!-- Контент -->
                <div class="flex-1">
                  <h3 class="text-xl md:text-2xl font-bold uppercase tracking-wider mb-2">
                    {{ item.title }}
                  </h3>
            ...
            <div class="border-2 border-black p-6 md:p-8 bg-white">
              <div class="flex flex-col md:flex-row gap-6 md:gap-8">
                ...
                <div class="flex-shrink-0">
                  <div
                    class="w-32 h-32 md:w-40 md:h-40 border-2 border-black bg-gray-100 overflow-hidden"
                  >
                    <img
                      :src="author.image"
                ...
                <div class="flex-1">
                  <div class="mb-4">
                    <h3 class="text-2xl font-bold uppercase tracking-wider mb-1">
                      {{ author.name }}
                    </h3>
        ...
        <div class="max-w-[1400px] mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div
              class="border-2 border-black bg-white p-6 hover:shadow-[6px_6px_0px_0px_rgba(234,109,58,1)] hover:translate-x-[-3px] hover:translate-y-[-3px] transition-all duration-200"
            >
              <p class="text-sm text-gray-700 leading-relaxed mb-4 italic">
                «За 6 недель вырос с 200 до 780 подписчиков в Telegram. Главное — появилась система:
                теперь я знаю, что и когда публиковать»
              </p>
            ...
            >
              <p class="text-sm text-gray-700 leading-relaxed mb-4 italic">
                «Менторство с Артёмом — это не лекции, а живая работа над моим конкретным проектом.
                Первые платные клиенты через блог пришли на 2-м месяце»
              </p>
              <div class="border-t-2 border-black pt-4">
            ...
            >
              <p class="text-sm text-gray-700 leading-relaxed mb-4 italic">
                «Думала, что для ведения блога нужен большой опыт. Оказалось — нужна только система.
                Сейчас пишу 4 раза в неделю и не испытываю стресса»
              </p>
              <div class="border-t-2 border-black pt-4">
      ...
      >
        <div class="max-w-[1400px] mx-auto">
          ...
          <div class="grid md:grid-cols-3 gap-6">
            ...
            >
              <div class="mb-6">
                <div class="text-4xl md:text-5xl font-black text-gray-300 mb-4">
                  {{ service.number }}
                </div>
                <h3 class="text-xl md:text-2xl font-bold uppercase tracking-wider mb-2">
                  {{ service.title }}
                ...
                <div class="flex items-baseline gap-2 mb-2">
                  ...
                  <span
                    :class="[
                      ...
                      service.highlighted ? 'text-gray-400' : 'text-gray-600',
                    ]"
                    >{{ service.period }}</span
                  >
                </div>
                <p
                  :class="['text-sm mt-3', service.highlighted ? 'text-gray-300' : 'text-gray-600']"
                >
                  {{ service.description }}
                </p>
              </div>
              ...
              <ul class="space-y-3 mb-8 flex-1">
                <li
                  ...
                  :class="[
                    ...
                    service.highlighted ? 'text-gray-300' : 'text-gray-700',
                  ]"
                >
                  <Check
                    :class="[
                      'w-4 h-4 flex-shrink-0 mt-0.5',
                      service.highlighted ? 'text-[#EA6D3A]' : 'text-black',
                    ]"
                  />
                  <span>{{ feature }}</span>
                </li>
              ...
              <NuxtLink
                ...
                :class="[
                  ...
                  service.highlighted ? 'bg-[#EA6D3A] text-white' : 'bg-black text-white',
                ]"
              >
                Записаться
              </NuxtLink>
              ...
              >
                Записаться
                <ExternalLink
                  :class="['w-3 h-3 ml-2', service.highlighted ? 'text-white' : 'text-white']"
                />
              </a>
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-[2fr_1fr] gap-8 md:gap-12 items-start">
            <div>
              ...
              <p class="text-base md:text-lg text-gray-700 max-w-xl leading-relaxed mb-8">
                База знаний «Нескучного Нетворкинга» — это маршруты обучения по 9 темам:
                контент-стратегия, личный бренд, платформы, продажи, мотивация, нетворкинг, история
                автора, реалити-проекты и инструменты ИИ.
              </p>
              <p class="text-base md:text-lg text-gray-700 max-w-xl leading-relaxed mb-8">
                Каждый пост отобран, структурирован и расположен в логичном порядке — от простого к
                сложному. Никакой воды, только практика и реальный опыт.
              </p>
              <NuxtLink
                href="/knowledge"
      ...
      >
        <div class="max-w-[1400px] mx-auto">
          ...
          <div class="space-y-2">
            <div v-for="(faq, index) in faqs" :key="index" class="border-2 border-black">
              <button
              ...
              >
                <span class="font-bold text-sm md:text-base uppercase tracking-wider pr-4">{{
                  faq.question
                }}</span>
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="inline-flex items-center justify-center font-medium px-5 py-3 bg-[#EA6D3A] text-white hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] transition-all duration-200 uppercase tracking-wider text-sm"
                >
                  Вступить в сообщество
                  <ArrowRight class="ml-2 h-4 w-4" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="inline-flex items-center justify-center font-medium px-5 py-3 border-2 border-white hover:bg-white hover:text-black hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] transition-all duration-200 uppercase tracking-wider text-sm"
                >
                  На диагностику
                ...
                <NuxtLink
                  to="/blog"
                  class="inline-flex items-center justify-center font-medium px-5 py-3 bg-white text-black hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] hover:translate-x-[-4px] hover:translate-y-[-4px] transition-all duration-200 uppercase tracking-wider text-sm"
                >
                  Читать блог
                  <ExternalLink class="ml-2 h-4 w-4" />
                </NuxtLink>
