        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div v-for="(project, index) in portfolio" :key="index"
            ...
            <div class="aspect-video flex items-center justify-center relative overflow-hidden"
              ...
              <img v-if="project.hasImage" :src="project.image" :alt="project.title" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
              <template v-else>
